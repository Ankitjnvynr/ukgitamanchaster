                ...
                <div class="col-md d-flex justify-content-center align-items-center ">
                    <div>
                        ...
                        <div class="mb-3 d-flex gap-2 flex-wrap">
                            <button id="volunTrigger" class=" flex-item btn btn-primary btn-bg fs-6" data-bs-toggle="modal" data-bs-target="#volunteerModal">Become a Volunteer</button>
                            <button class=" flex-item btn btn-primary btn-bg fs-6" data-jg-donate-button data-charityId="3576214" data-marketCode="GB" data-linkType="givingCheckout">Donate Now</button>
                            <button id="sponsorTrigger" class=" flex-item btn btn-primary btn-bg fs-6" data-bs-toggle="modal" data-bs-target="#sponserModal">Become a Sponsor</button>

                        </div>

                        <div class="d-flex flex-wrap gap-2">
                            <button class=" flex-item  btn btn-primary btn-bg fs-6" data-day="1" onclick="redirectTo1()">Friday</button>
                            <button class="flex-item btn btn-primary btn-bg fs-6" data-day="2" onclick="redirectTo2()">Saturday</button>
                            <button class="flex-item btn btn-primary btn-bg fs-6" data-day="3" onclick="redirectTo3()">Sunday</button>
                        </div>

...
<body>
    ...
    <div id="events" class="container my-5 py-4 event-section">
        ...
        <div class="heading text-center mb-4">
            <h2 class="fw-semibold text-uppercase text-danger-emphasis">Upcomming Events</h2>
        </div>
        <div class="spacer"></div>
        <div class="row">
            <div class="col-md-4 overflow-hidden rounded">
                <img style="max-width :100%;" class="rounded" src="imgs/manchaster gita festivel 2025.jpg" alt="">
            </div>
            <div class="col-md-8">
